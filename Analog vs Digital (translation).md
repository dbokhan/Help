...
Хоть аналоговые сигналы и могут быть ограничены максимальным и минимальным принимаемыми значениями, но они могут принимать бесконечное множество значений в рамках этого диапазона. Например, аналоговое напряжение выходящее из розетки в вашей стене может варьироваться от -120В до +120В, но если Вы начнете рассматривать график в наибольшем приближении, Вы обнаружите, что сигнал принимает бесконечное число значений (например, 64.4V, 64.42V, 64.424V и другие значения из его диапазона)
