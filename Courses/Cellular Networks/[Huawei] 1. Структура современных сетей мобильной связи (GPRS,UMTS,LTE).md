...
1. [Архитектура 2G сетей (GSM/GPRS)](#архитектура-сетей-2g)
2. [Архитектура 3G сетей (UMTS)](#архитектура-сети-umts-3g)
3. [Архитектура 4G сетей (LTE)](#архитектура-сети-lte-4g)
...
4. [Вопросы для самопроверки](#вопросы-для-самопроверки)
