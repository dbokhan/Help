...
*Содержание в логическом порядке*
...
В 2001 году в 3GPP Release 4 было принято разделить MSC на две части **MSC Server**, который дает сигнализацию MGW на коммутацию трафика и **MGW (Media Gateway)**. MGW приближаются к BSS подсистеме, а MSC Server остается один на регион.
