...
![](img/WCDMA_RAN/lub_interface.png)
...
![](img/WCDMA_RAN/lur_interface.png)

## WCDMA - что называется каналами?

![](img/WCDMA_RAN/channel_types.png)

**Логические каналы** бывают двух типов:

1. **Трафиковые каналы**

1.1 **Выделенный трафиковый канал (DTCH - Dedicated Traffic Channel)** - это передача данных конкретному абоненту

1.2 **Общий трафиковый канал (CTCH - Common Traffic Channel)** - это передача данных, которая может быть декодирована всеми абонентами

2. **Каналы упарвления**

2.1. **Широковещательный канал управления (BCCH - Broadcast Control Channel)** - используется для передачи системной информации

2.2. **Канал управления сооьщениями вызова (PCCH - Paging Control Channel)** - передача вызова сообщений

2.3. **Общий канал управления (CCCH - Common Control Channel)** - используется пользователями, пока им не назначен выделенный канал для передачи сигнализации (т.е. при начальном доступе)

2.4. **Выделенный канал управления (DDCH - Decicated Control Channel)**
