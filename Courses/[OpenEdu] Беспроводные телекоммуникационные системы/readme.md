...
**Формула для расчета:**
	...
	L(new) - средняя велеина потерь (по методу Окамура)

	A - усредненное дополтиельное ослабление, обусловленное влиянием земной поверхности (расчитывается по первому графику)
