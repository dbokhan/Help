...
Граница дальней зоны находится по формуле:
	...
	D - это максимальный размер антенны, м (метры)
...
ht = 100 м *это высота подвеса антенны источника*
...
Для решения этой задачи используются значения из кривых Окамура-Хата, но до этого необходимо найти мощность приемника, как описывается в задаче 4, потом найти потери в радио канале при сводном распространении, как описано в задаче 3.
